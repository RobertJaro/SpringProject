...
if __name__ == '__main__':
    # KSO
    files = glob.glob("/observations/solarnet-campaign/level0/kso/*.fts.gz")
    ...
    files = glob.glob("/observations/solarnet-campaign/level0/catania/*.fts")
    base_dir = "/localdata/USER/rja/solarnet"
    ...
    # PSPT
    files = glob.glob("/observations/solarnet-campaign/level0/rome/*.ffc")
    base_dir = "/localdata/USER/rja/solarnet"
    ...
    # ROB - caiik
    files = glob.glob("/observations/solarnet-campaign/level0/rob/UCC*.FTS")
    base_dir = "/localdata/USER/rja/solarnet"
    ...
    # ROB - h-alpha
    files = glob.glob("/observations/solarnet-campaign/level0/rob/UCH*.FTS")
    base_dir = "/localdata/USER/rja/solarnet"
    os.makedirs(os.path.join(base_dir, 'rob'), exist_ok=True)
    ...
    # ROB - white light
    files = glob.glob("/observations/solarnet-campaign/level0/rob/UPH*.FTS")
    base_dir = "/localdata/USER/rja/solarnet"
    os.makedirs(os.path.join(base_dir, 'rob'), exist_ok=True)
