...
for i, (group, day) in enumerate(df):
    ...
    plt.text(sunrise, 1.5, "Sunrise KSO", rotation=90, verticalalignment="center", fontsize=6)

    plt.vlines(sunset, ymin=0, ymax=3, linewidth=5, colors="yellow")
    plt.text(sunset, 1.5, "Sunset KSO", rotation=90, verticalalignment="center", fontsize=6)
...
plt.savefig("C:\\Users\\Robert\\Documents\\Uni\\SOLARNET\\HomogenizationCampaign\\kso_overview.png")